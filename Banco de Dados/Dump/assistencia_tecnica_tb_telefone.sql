...
CREATE TABLE `tb_telefone` (
  ...
  `telefone_tel` varchar(20) NOT NULL,
  `responsavel_tel` varchar(50) DEFAULT NULL,
  `dataAniversario_tel` varchar(15) DEFAULT NULL,
  `departamento_tel` varchar(50) DEFAULT NULL,
  `id_pessoa_fk_tel` int NOT NULL,
  PRIMARY KEY (`id_tel`),
  KEY `id_pessoa_fk_tel` (`id_pessoa_fk_tel`),
  CONSTRAINT `tb_telefone_ibfk_1` FOREIGN KEY (`id_pessoa_fk_tel`) REFERENCES `tb_pessoa` (`id_pes`)
